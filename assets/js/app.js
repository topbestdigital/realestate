...
$("#pills-tabconn2 .nav-link").first().addClass("active");
$("#pills-tabconnContent2 .tab-pane").first().addClass("show active");
...
platformName = ua.match(/ip(?:ad|od|hone)/) ? "ios" : (ua.match(/(?:webos|android)/) || platform.match(/mac|win|linux/) || ["other"])[0], isMobile = /ios|android|webos/.test(platformName), isMobile || (window.$zopim || function (e, t) {
  ...
  n.set = function (e) {
    n.set._.push(e)
  }, n._ = [], n.set._ = [], i.async = !0, i.setAttribute("charset", "utf-8"), i.src = "//v2.zopim.com/?3cQBoFplIdumhew779oMP9Z74YIjvGyO", n.t = +new Date, i.type = "text/javascript", o.parentNode.insertBefore(i, o)
})